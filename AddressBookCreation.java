...
public class AddressBookCreation {
	...
	public AddressBookCreation(String firstname, String lastname, String address, String city, String state, String zip,
	...
	public void display() {
		...
		for (int j = 0; j < person.size(); j++) {
			AddressBookCreation address_book = person.get(j); // get method takes an index to look for an object in
																// collection list
	...
	public void search(String place) {
        ...
        System.out.println("Number of people belonging to same place are : "+count);
	}
